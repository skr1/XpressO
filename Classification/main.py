...
def main(args):
    ...
    for i in folds:
        ...
        results, test_auc, val_auc, test_acc, val_acc, test_precision, val_precision, test_recall, val_recall, test_f1, val_f1 = train(datasets, i, args)
...
if args.task == 'gene_exp':
    args.n_classes = 2
    data_dirs = {
        'low_expression_genes': os.path.join(args.data_root_dir, 'low_expression_genes'),
...
if args.split_dir is None:
    # args.split_dir = os.path.join('splits', args.task+'_{}_'.format(int(args.label_frac*100)))
